...
'astrologie-guidance': {
  categorie: 'Astrologie & guidance',
  titre: 'L’astrologie comme boussole intérieure',
  date: '19 mars 2026',
  contenu:
    '<h2>Ce que c’est (et ce que ce n’est pas)</h2>' +
    '<p>L’astrologie n’est pas une science exacte ni une machine à prédictions garanties, c’est un langage symbolique basé sur les mouvements des astres et leurs correspondances avec la vie humaine.</p>' +
    '<p>Elle s’appuie sur l’astronomie (la position réelle des planètes, du Soleil, de la Lune), mais son but est de donner du sens, d’éclairer les tendances psychologiques, les potentiels et les défis, plutôt que de dire « il va t’arriver ça tel jour ».</p>' +
    '<p>L’approche moderne est très proche de la connaissance de soi : on lit le thème natal comme une carte énergétique, pas comme une condamnation.</p>' +

    '<h2>Les briques de base</h2>' +
    '<p>On retrouve toujours quelques grands éléments dans un thème : les signes du zodiaque (12 manières d’être), les planètes (les fonctions en nous), les maisons astrologiques (12 domaines de vie) et les aspects (les relations entre ces énergies).</p>' +
    '<p>On peut résumer ainsi : le signe indique le type d’énergie, la planète la fonction, la maison le domaine de vie et l’aspect la façon dont ces fonctions collaborent ou se frottent entre elles.</p>' +

    '<h2>Le thème natal</h2>' +
    '<p>Le thème natal est une carte du ciel au moment exact de la naissance. On y place les planètes dans les signes et les maisons, puis on observe les aspects entre elles pour lire une sorte de « météo intérieure » : talents, besoins, zones de tension et pistes d’évolution.</p>' +

    '<h2>Astrologie prévisionnelle</h2>' +
    '<p>L’astrologie prévisionnelle ne décrit pas des événements précis, mais des climats : périodes de remise en question, de construction, d’ouverture ou de bilan, en observant comment les mouvements actuels des planètes activent certains points du thème natal.</p>' +

    '<h2>Dans une démarche de guidance</h2>' +
    '<p>Dans une démarche de guidance, l’astrologie aide à mettre des mots sur ce qu’une personne ressent déjà : blocages, répétitions, besoins profonds, cycles émotionnels. Elle offre une grille de lecture pour accepter certains fonctionnements, développer d’autres potentiels et mieux vivre les périodes de transition plutôt que les subir.</p>'
},
